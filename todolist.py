...
add=Button(window,text="ADD",font="Ariel 20",padx=30,command= lambda content=content,task=task:content.insert(END,task.get()))
delete=Button(window,text="DELETE",font="Ariel 20",command= lambda content=content:content.delete(ANCHOR))
